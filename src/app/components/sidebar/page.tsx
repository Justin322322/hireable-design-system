    ...
    <div className="container max-w-4xl py-12 px-4 md:px-8">
      ...
      <Tabs defaultValue="examples" className="space-y-8">
        ...
        <TabsContent value="examples" className="space-y-8">
          ...
          <CodeBlock
            code={`// Talent variant - for job seekers
<AppSidebar variant="talent" />
...
// Profile: Avatar image with user name and email`}
          ...
          <CodeBlock
            code={`// Employer variant - for hiring managers
<AppSidebar variant="employer" />
...
// Profile: Avatar image with company name and email`}
          ...
          <CodeBlock
            code={`// Admin variant - for platform administrators
<AppSidebar variant="admin" />
...
// Profile: Initials avatar with admin name and email`}
          ...
          <CodeBlock
            code={`// Sidebar dimensions (from Figma)
// Width: 280px
