...
<div className="flex flex-col gap-2">
  ...
  <span className="text-sm text-muted-foreground">Helper text</span>
        ...
        <CodeBlock
          code={`import { SelectContent, SelectItem } from "@/components/ui";
  ...
  <CommandList>
    ...
    <CommandItem>
      <Checkbox label="France" />
        ...
        <CodeBlock
          code={`import { SelectItem } from "@/components/ui";

<SelectItem value="option">Insert Option</SelectItem>
...
// bg-button-secondary-default for selected`}
        ...
        <CodeBlock
          code={`import { Icon, SelectItem } from "@/components/ui";

<SelectItem value="option" className="flex items-center gap-2">
  <Icon icon="add" size={24} className="text-icon" />
  Insert Option
</SelectItem>`}
          language="tsx"
