  ...
  "inline-flex items-center justify-center font-secondary font-normal uppercase tracking-wider transition-colors focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none",
  {
    variants: {
      variant: {
        ...
        outline: "bg-success/10 text-success border-[0.643px] border-success rounded-[5.15px] px-2 text-[7.72px] leading-none h-[19.3px] box-border",
        ...
        muted: "border-neutral-300 bg-muted text-neutral-700 shadow-none rounded-md px-2.5 py-0.5 text-xs font-semibold",
      },
    },
    defaultVariants: {
      variant: "default",
